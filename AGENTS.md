...
- `cd frontend && npm ci && npm run dev` installs the locked frontend dependencies and starts Vite.
- `cd frontend && npm run lint && npm run build` reproduces frontend CI checks.
